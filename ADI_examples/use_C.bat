...
copy ADI_examples\C_separate_16\abcc_network_data_parameters.c src\example_application\*.*
REM pause 

ECHO Copying the file abcc_driver_config.h
copy ADI_examples\C_separate_16\abcc_driver_config.h src\abcc_adaptation\*.*
REM pause
...
ECHO Copy cfg files
xcopy /s ADI_examples\C_separate_16\cfg_files cfg_files\*.*
REM pause

ECHO Copying the file C_separate_16_selected.txt
copy ADI_examples\C_separate_16\C_separate_16_selected.txt ADI_examples\*.*
REM pause
