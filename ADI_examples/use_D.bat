...
CLS
ECHO ****************************************************************************************************
ECHO * This batch file use_D.bat copies the following files           					*
ECHO * - abcc_network_data_parameters.c				      					*
ECHO * - abcc_driver_config.h				      	      					*
ECHO * for the alltypes application to the example_application folder.					*
ECHO *													*
...
copy ADI_examples\D_alltypes\abcc_network_data_parameters.c src\example_application\*.*
REM pause 

ECHO Copying the file abcc_driver_config.h
copy ADI_examples\D_alltypes\abcc_driver_config.h src\abcc_adaptation\*.*
REM pause
...
ECHO Copy cfg files
xcopy /s ADI_examples\D_alltypes\cfg_files cfg_files\*.*
REM pause

ECHO Copying the file D_alltypes_selected.txt
copy ADI_examples\D_alltypes\D_alltypes_selected.txt  ADI_examples\*.*
REM pause
