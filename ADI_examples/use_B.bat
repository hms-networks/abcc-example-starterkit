...
ECHO * for the simple_16 application to the example_application folder.					*
ECHO *													*
...
copy ADI_examples\B_simple_16\abcc_network_data_parameters.c src\example_application\*.*
REM pause 

ECHO Copying the file abcc_driver_config.h
copy ADI_examples\B_simple_16\abcc_driver_config.h src\abcc_adaptation\*.*
REM pause
...
ECHO Copy cfg files
xcopy /s ADI_examples\B_simple_16\cfg_files cfg_files\*.*
REM pause

ECHO Copying the file B_simple_16_selected.txt
copy ADI_examples\B_simple_16\B_simple_16_selected.txt  ADI_examples\*.*
REM pause
